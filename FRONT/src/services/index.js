...
const BASE_URL = 'https://distinct-nest-production.up.railway.app'

export default class ApiDashboard {
	/* METODO GET */
	async getData(lastUrl) {
		return axios
			.get(`${BASE_URL}/${lastUrl}`, {
				headers: {
