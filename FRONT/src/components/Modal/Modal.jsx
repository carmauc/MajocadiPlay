...
const Modal = ({ children, title, type, id, movie }) => {
	...
	const handleAddMovie = () => {
		...
		if (type === 'add') {
			service.postData('movies', movie).then(res => {
				if (res.status === 201) {
					Swal.fire({
						icon: 'success',
						title: 'Movie added!',
			...
			service.putData('movies', keyMovie, movie).then(res => {
				if (res.status === 200) {
					Swal.fire({
						icon: 'success',
						title: 'Movie updated!',
				...
				<div className='modal-content'>
					...
					<div className='modal-body'>
						<form>
							...
							<div className='mb-1'>
								<label htmlFor='official_site' className='form-label'>
									{' '}
									Official Site{' '}
								</label>
								<input
									...
									id='official_site'
									value={official_site}
									onChange={e => setOfficial_site(e.target.value)}
								/>
							</div>
							<div className='mb-1'>
