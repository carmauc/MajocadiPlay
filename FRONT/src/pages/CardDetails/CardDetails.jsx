					...
					<div className='row'>
						...
						<div className='col-12 col-md-6'>
							...
							<p className='text-black'>
								<span className='fw-bold'>Sinopsis: </span>
								{movie.description}
							</p>
							<p className='text-black'>
							...
							<p className='text-black'>
								<span className='fw-bold'>ID IMDB: </span>
								{movie.id_movie}
							</p>
							<p className='text-black'>
								<span className='fw-bold'>Official Site: </span>
								<a href={movie.official_site}>{movie.official_site}</a>
							</p>
							<p className='text-black'>
								<span className='fw-bold'>Tailer: </span>
							</p>
							<iframe
								width='400px'
								height='250px'
